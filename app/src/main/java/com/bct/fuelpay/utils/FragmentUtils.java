 ...
 * <p>
 * Author: Keith Dsouza
 * Email: keith.dsouza1990@gmail.com
 * Created: 05/01/2023
 * Modified: 05/01/2023
 */
public class FragmentUtils {
    ...
    public static void replaceFragment(AppCompatActivity activity, Fragment fragment, Bundle b, int id, boolean addToBackStack, @FragmentAnimation int animationType) {
